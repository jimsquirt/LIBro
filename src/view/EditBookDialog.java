...
public class EditBookDialog extends JDialog {
	...
	private void initDialog() {
		setSize(400, 500);
		setLayout(null);
		setTitle("LIBro - Edit Book Information");
		setResizable(false);
		setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
	}

	private void initComponents() {
		JLabel dialogTitle = new JLabel("Edit Book Information");
	...
	public void loadBookData(String title, String desc, String author, int qty) {
